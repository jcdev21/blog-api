...
var ClientBlogController_1 = __importDefault(require("../../controllers/client/ClientBlogController"));
var ClientBlogRoutes = /** @class */ (function (_super) {
    ...
    ClientBlogRoutes.prototype.routes = function () {
        this.router.get('/', ClientBlogController_1.default.index);
        this.router.get('/:id', ClientBlogController_1.default.show);
    };
