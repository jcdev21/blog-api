...
var ClientBlogService = /** @class */ (function () {
    function ClientBlogService(req) {
        ...
        this.getAll = function () { return __awaiter(_this, void 0, void 0, function () {
            var limit, pages, pageNumber, offset, blogs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        limit = 2;
                        pages = this.query.pages;
                        pageNumber = Number(pages) || 1;
                        offset = (pageNumber - 1) * limit;
                        return [4 /*yield*/, db.blog.findAndCountAll({
    ...
    return ClientBlogService;
}());
exports.default = ClientBlogService;
